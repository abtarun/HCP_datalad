...
# Usage : python computeMorphometry.py $path-to-parcellation-nifti-files $path-to-functional-volume $subject-ID $directory-where-to-save-outputs $morphometric (e.g., 'area')
# 
# Author: Anjali Tarun
...
for i in range(5):
    ...
    p1 = os.path.join(save_dir, 'sub-'+Id+'_'+fil+'_atlas-L2018_res-scale'+str(i+1)+'_dseg.mat')
    p2 = os.path.join(save_dir, 'sub-'+Id+'_'+fil+'_atlas-L2018_res-scale'+str(i+1)+'_dseg.npz')
